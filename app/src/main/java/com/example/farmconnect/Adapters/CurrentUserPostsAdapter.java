...
public class CurrentUserPostsAdapter extends RecyclerView.Adapter<CurrentUserPostsAdapter.CurrentUserPostsHolder> {
    ...
    public CurrentUserPostsAdapter(List<Post> postList, Context context) {
    ...
    public CurrentUserPostsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CurrentUserPostsHolder(view);
    }
...
//        Log.d("Description",post.getDiscription().toString());
    ...
    public static class CurrentUserPostsHolder extends RecyclerView.ViewHolder {
        ...
        public CurrentUserPostsHolder(@NonNull View itemView) {
            super(itemView);
            // Initialize views
